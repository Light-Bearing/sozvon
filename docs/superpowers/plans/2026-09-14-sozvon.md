...
> 17.09.2026. Задача 14 (сторож адресов) не сделана; пробник, на котором
> она стояла бы, починен 24.09 — прежний записывал живые mqtt-брокеры в
> мёртвые. Живое состояние проекта — в README, раздел «Состояние».
