...
describe('сводка о связи', () => {
  ...
  // предсказуемо). Раньше все отчёты сваливались в один плоский список и
  ...
  describe('снимки не путаются между собеседниками', () => {
    it('одинаковый report.id у разных собеседников не мешает каждому посчитаться отдельно', () => {
      ...
      // Тик 1: у обоих исходящий поток получил один и тот же id.
      tracker.summarize([
  ...
  // Находка 4, вторая часть: снимки не убирались никогда и без ограничения
